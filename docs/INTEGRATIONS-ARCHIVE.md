> Historical integration configuration. The current default is the local Town workshop; see [the current README](../README.md). This document describes the preserved integration service, not the active map. Hosted deployment claims below are historical and require fresh verification.
...
[Deployment](docs/DEPLOY.md) · [City protocol](docs/CITY.md) · [Webhooks](docs/WEBHOOKS.md) · [Authentication](docs/AUTH.md) · [Rules](docs/RULES.md) · [Engine](docs/ENGINE.md) · [Support matrix](docs/SUPPORT.md) · [Performance](docs/PERFORMANCE.md) · [Reconstruction](docs/RECONSTRUCTION-STATUS.md) · [Handoff archive](docs/PHASER-RECONSTRUCTION-HANDOFF.md)
