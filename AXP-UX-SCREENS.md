...
On Mac: `~/AXP-city-sprites/`

Notable sheets discussed/generated:
- Buildings small/medium/large (`buildings-small-01-17.png`, `buildings-medium-18-34.png`, `buildings-large-35-50.png`)
- Environment tiles (`environment-tiles.png`)
- Raw materials, planning tables, lot-state examples (v2)
- Robot crew, agent drones (v3)
- Ground construction bots, facade drones (v4)
- Earlier pixel Kairosoft-style kit (01–05) and Hunter HTML mock

User also committed further assets onto the Origin branch — treat repo `assets/` (or equivalent) as source of truth going forward alongside this doc.
